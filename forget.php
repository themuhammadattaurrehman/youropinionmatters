...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($select12)) {
        ...
        if (mail($email, "Forget Password Recovery", "Hi, Your password is: $pass")) {
            header("location:login.php?success=Your password has been sent in your email inbox successfully");
        } else {
            $errorMsg = "wrong email sending failed...";
            // header("location:forget.php?error=wrong email sending failed...");
        }
    } else {
        // JavaScript alert for email not found
        $errorMsg = "Email not found.";
        // header("location:forget.php?error=Email not found");
        // echo '<script>alert("Email not found"); window.location = "forget.php";</script>';
    }
}
?>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Enter your email for get mail</p>
                                    </div>
...
<!-- <script>
        ...
        // Get the value of the 'success' parameter from the URL
        var successMessage = getParameterByName('error');
