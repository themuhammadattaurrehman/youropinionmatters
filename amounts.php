              ...
              ?>
                    <table class="table blue-table shadow rounded">
                        ...
                        <tbody>
                            ...
                            WHERE quiz.attempted = 1 AND quiz.approved = 1 AND quiz.userid=$id";
                ...
                <p class="contact-info">For any query or problem, please contact at <a href="mailto:inquire@uropinionmatters.com">inquire@uropinionmatters.com</a></p>
            </div>
        </div>
    </main>
    <script>
